...
{
	int* newArray = new int[len];  //creating a new array with size len
	for(int i = 0; i < len; i ++){
		newArray[i] = 0;  // sets elements of the array to 0
	}
	return newArray;  // returning the pointer to the new array
}
